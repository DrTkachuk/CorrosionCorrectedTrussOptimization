function [Arfinal,tau,tot_it,tot_time,ArNormEvol] = MinVolumeGivenComplAndFreq_fixed_aspect_ratio_weight2(nele,nfree,taumax,Ascaling,Alowvec,Ahighvec,Kmax,Qred,Fred,Lvector,Aredtop,Aredside,alpha,niter)
...
Weights=eye(nele)+diag((Aredside/sqrt(alpha)+Aredtop*sqrt(alpha))./sqrt(4*Ar/Ascaling-3*Aredside.*Aredtop ));
