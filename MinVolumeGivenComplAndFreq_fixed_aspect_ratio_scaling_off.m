function [Arfinal,tau,tot_it,tot_time,ArNormEvol] = MinVolumeGivenComplAndFreq_fixed_aspect_ratio_scaling_off(nele,nfree,taumax,Ascaling,Alowvec,Ahighvec,Kmax,Qred,Fred,Lvector,Aredtop,Aredside,alpha,niter)
