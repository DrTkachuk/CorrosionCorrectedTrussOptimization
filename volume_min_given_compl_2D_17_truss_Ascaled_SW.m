...
[A,tau,tot_it2,tot_time2]=MinVolumeGivenComplRustSelfWeight(nele,nfree,taumax,Ascaling,Alow,Ahigh,Kmax,Qred,Jred,Fred,Lvector,Aredtop,Aredside)


[AwoRed,tauwoRed,tot_it3,tot_time3]=MinVolumeGivenComplRustSelfWeight(nele,nfree,taumax,Ascaling,Alow,Ahigh,Kmax,Qred,Jred,Fred,Lvector,zeros(nele,1),zeros(nele,1))
