function [Afinal,tau,tot_it,tot_time] = MinVolumeGivenComplRust(nele,nfree,taumax,Ascaling,Alow,Ahigh,Kmax,Qred,Fred,Lvector,Aredtop,Aredside)
...
cvx_begin
  variable A(nele) 
   ...
   [tau Fred'/sqrt(Kmax); Fred/sqrt(Kmax) (Qred*diag((A/Ascaling-Aredtop-A.*Aredside/Ascaling+Aredtop.*Aredside))*Qred')/Kmax] == semidefinite(nfree+1)
